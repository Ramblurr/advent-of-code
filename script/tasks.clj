;;  from @tschady https://github.com/tschady/advent-of-code/blob/main/script/tasks.clj
(ns tasks
  (:require
...
(require '[cprop.source :refer [from-env-file]])
...
(def headers {:headers
              {"Cookie"    (str "session=" (or (:aoc-session config) (System/getenv "AOC_SESSION")))
               "UserAgent" (str (or (:aoc-repo config) (System/getenv "AOC_REPO"))
                                " by "
                                (or (:aoc-email config) (System/getenv "AOC_EMAIL")))}})
